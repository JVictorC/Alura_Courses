...
class FormNotaActivity : AppCompatActivity() {
    ...
    private val repositoryNotas by lazy {
        NotaRepository(AppDatabase.instancia(this).notaDao(), NotasWebClient())
    }
